	    ...
	    <div id="container_left">
	        ...
	        <div id="menu">
	            <ul>
	                ...
	                <li class="active"  class="menuli"  onclick="atagClick(4)">1元夺宝</li>
	                <li class="menuli"  onclick="atagClick(5)">退出系统</li>
	            </ul>
	        </div>
		</div>
		<iframe src="yiyuanproduct_list.jsp" width="80%" height="100%" style="float:right" frameborder="no" border="0" marginwidth="0" marginheight="0"></iframe>
   </div>
     <!--弹出层确认删除-->
