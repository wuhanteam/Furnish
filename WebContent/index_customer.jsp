	...
	<body>
	    ...
	    <div id="container_left">
	        <div id="left_top">
	            ...
	            <h2 style="text-align: center"><%=request.getSession().getId()%>欢迎登入!</h2>
	        </div>
	        ...
	        <div id="menu">
	            <ul>
	                ...
	                <li  class="active" class="menuli"  onclick="atagClick(2)">客户管理</li>
		...
		<iframe src="customer_list.jsp" width="80%" height="100%" style="float:right" frameborder="no" border="0" marginwidth="0" marginheight="0"></iframe>
   </div>
     <!--弹出层确认删除-->
