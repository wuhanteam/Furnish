	...
	<div class="header">
		<div class="container">
			<div class="header-top">
				<div class="logo">
					<a href="index.html"><h6>Online Furnish</h6>
						<h2>Luxury</h2></a>
				</div>
					...
					<div class="col-md-9">
						<div class="dreamcrub">
							<ul class="breadcrumbs">
								...
								<li class="home"><a href="about.html"
									title="Go to Home Page">About</a>&nbsp; <span>&gt;</span></li>
								<li class="home">&nbsp; Beds <span>&gt;</span>&nbsp;
								</li>
							</ul>
							<ul class="previous">
							...
							<div class="labout span_1_of_a1">
								<div class="flexslider">
									<ul class="slides">
										...
										<c:forEach items="${sessionScope.single_goods.imageList }"
											var="imageItem">
											<li data-thumb="${imageItem }"><img src="${imageItem }" />
											</li>
										</c:forEach>
						...
						-->
							...
							<div class="cont1 span_2_of_a1 simpleCart_shelfItem">
								<h1>${sessionScope.single_goods.goods_name}</h1>


								<form action="addCart.action" method="get">

									<!-- 隐藏域: 放goods_id ,便于提交数据 -->
									<input type="text"
										value="${sessionScope.single_goods.goods_id}" hidden="hidden" name="goods_id">
									...
									<div class="price_single">
										<span class="amount item_price actual">$${sessionScope.single_goods.goods_price}</span><a
											href="#">click for offer</a>
									</div>
									<h3 class="quick">商品简介:</h3>
									<p class="quick_desc">${sessionScope.single_goods.goods_desc}</p>
									<ul class="size">
										<h3>Size</h3>
										<!-- size_info ,需要提交 -->
										<c:forEach items="${sessionScope.single_goods.sizeList}"
											var="sizeItem">
											<li><input name="size" type="radio" value="${sizeItem }"><a>${sizeItem }</a></li>
										</c:forEach>
									...
									<div class="tab-1 resp-tab-content"
										...
										<div class="facts">
											<ul class="tab_list">
												...
												<li><a href="#">claritatem insitam; est usus
														...
														Mirum est notare quam littera gothica</a></li>
						...
						<ul id="flexiselDemo3">
							<li><img src="images/pic11.jpg" class="img-responsive" />
								<div class="grid-flex">
									<a href="#">Syenergy 2mm</a>
									<p>Rs 850</p>
								</div></li>
							<li><img src="images/pic10.jpg" class="img-responsive" />
								<div class="grid-flex">
									<a href="#">Surf Yoke</a>
									<p>Rs 1050</p>
								</div></li>
